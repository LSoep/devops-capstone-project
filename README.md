...
![Build Status](https://github.com/LSoep/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)
...
You should use this template to start your DevOps Capstone project. It contains all of the code that you will need to get started. Thi is very important!
